...
#   filename:  workdir/storage_gcp_upbound_io_v1beta1_hmackey.yaml
...
class ServiceAccountEmailSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    serviceAccountEmailRef: Optional[ServiceAccountEmailRef] = None
    """
    Reference to a ServiceAccount in cloudplatform to populate serviceAccountEmail.
    """
    serviceAccountEmailSelector: Optional[ServiceAccountEmailSelector] = None
    """
...
class HMACKeyList(BaseModel):
    ...
    items: List[HMACKey]
    """
    List of hmackeys. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
